...
int main()
{
    ...
    printList(lst3);
    const SortedList<string> lst5 = lst3.apply(getLen);
    printList(lst5);
    cout << lst5.length() << endl;
    ...
    TEST("1.10")
    const SortedList<ExamDetails> lst4 = lst2.filter(isTrollLink);
    printList(lst2);
    cout << "----------" << endl;
    printList(lst4);
    cout << lst4.length() << endl;
    lst2 = lst4.filter(isTrollLink);
    printList(lst2);
