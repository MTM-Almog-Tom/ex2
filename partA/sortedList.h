...
namespace mtm
{
    ...
    public:
        ...
        public:
            ...
            bool operator==(const_iterator iter) const; // operator ==

            const T &operator*() const; //operator *

            friend class SortedList<T>;

            bool operator!=(const_iterator other) const; // operator !=
        };
        ...
        SortedList<T> filter(condition cond) const; //return a list containing only values that pass the filter function

        template<class operation>
        SortedList<T> apply(operation func) const; //return a list containing all the values after the apply changed them.
    ...
    template<class T>
    template<class condition>
    SortedList<T> SortedList<T>::filter(condition cond) const
    {
    ...
    template<class T>
    template<class operation>
    SortedList<T> SortedList<T>::apply(operation func) const
    {
        SortedList<T> new_list;
        for (auto iterator = begin(); iterator != end(); ++iterator)
        {
    ...
    template<class T>
    bool SortedList<T>::const_iterator::operator==(const_iterator iter) const
    {
    ...
    template<class T>
    bool SortedList<T>::const_iterator::operator!=(SortedList::const_iterator other) const
    {
